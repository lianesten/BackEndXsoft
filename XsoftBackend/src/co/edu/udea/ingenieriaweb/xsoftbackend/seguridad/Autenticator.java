...
public class Autenticator {
    ...
    /**
     * Clave para obtener el identificador del usuario
     */
    public static final String USER_ID = "userId";
    
    /**
     * Clave para obtener el nombre de usuario
     */
    ...
    public  Usuario  decodeToken (String token){
        ...
        jwtparametros = Json.createReader(new ByteArrayInputStream(Base64.decodeBase64(jwtParts[1])))
         ...
         System.out.println("Identificación del usuario: " + usuario.getNumeroId());
